                            ...
                            <tbody>
                                @foreach ($services as $service)
                                    <tr>
                                        ...
                                        <td class="align-content-center  description-column">{{ $service->description }}
                                        </td>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-floating mb-3">
                                            <textarea class="form-control" placeholder="Description" id="description" name="desc" style="height: 150px;"
                                                required></textarea><label for="description">Description</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-xl-4">
                                        ...
                                        <div class="text-start mb-3">
                                            ...
                                            <input class="form-control form-control-sm bg-dark" id="serviceImg"
