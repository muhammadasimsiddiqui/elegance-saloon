                            ...
                            <div class="container-fluid">
                                ...
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand" href="{{ url('/') }}">
                                        <img src="{{ asset('frontend/assets/images/others/white-logo.png') }}"
                                            alt="Elegance Salon">
                                    </a>
                                </div> <!--/.navbar-header-->
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <div class="top-right-contact text-right pull-right hidden-sm hidden-xs">
                                        {{-- <i class="fa fa-phone-square"></i> +92 329 0331394 --}}
                                          ...
                                          @if (!Auth::check())
                                            <a class="btn btn-primary sbtn-hvr-out" href="{{ url('/signup') }}">Create
                                            Account</a>
                                        @endif
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="{{ Route::currentRouteName() == 'appointment' ? 'active' : '' }}"><a
                                                href="{{ url('/appointment') }}">Appointment</a></li>
                                        <li class="{{ Route::currentRouteName() == 'contact' ? 'active' : '' }}"><a
                                                href="{{ url('/contact') }}">Contact</a></li>

                                        @if (Auth::check())
                                            <li class=""><a
                                                    href="{{ url('/userlogout') }}">Logout</a></li>
                                        @else
                                            <li class="{{ Route::currentRouteName() == 'signin' ? 'active' : '' }}"><a
                                                    href="{{ url('/signin') }}">Log In</a></li>
                                        @endif
