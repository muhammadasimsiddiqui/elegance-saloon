...
<html lang="en">
    <head>
        ...
        <link rel="apple-touch-icon" href="frontend/assets/favicon/apple-icon-57x57.png">
        ...
        <!-- OwlCarousel css -->
        <link rel="stylesheet" href="frontend/assets/css/vendor/owl.carousel.css">
        <link rel="stylesheet" href="frontend/assets/css/vendor/owl.theme.css">
        <!-- bootstrap date picker -->
        <link rel="stylesheet" href="frontend/assets/css/vendor/bootstrap-datepicker.standalone.css">
        <!-- theme style css -->
        <link rel="stylesheet" href="frontend/assets/css/style.min.css">
        <!-- responsive css -->
        <link rel="stylesheet" href="frontend/assets/css/responsive.min.css">
    ...
    <body>
        ...
        <script src="frontend/assets/js/vendor/jquery-3.1.1.min.js"></script>
        <!-- bootstrap latest version -->
        <script src="frontend/assets/js/vendor/bootstrap.min.js"></script>

		<!--Appear js file-->
        <script src="frontend/assets/js/vendor/jquery.appear.js"></script>
        <!--CountTo js file-->
        <script src="frontend/assets/js/vendor/jquery.countTo.js"></script>
		<!--Owl Carousel js file-->
        <script src="frontend/assets/js/vendor/owl.carousel.min.js"></script>
        <!--bootstrap date picker js file-->

        <!-- jquery form validator, date picker & booking js -->
        <script src="frontend/assets/js/vendor/bootstrap-datepicker.min.js"></script>
        <script src="frontend/assets/js/vendor/validator.min.js"></script>
        <script src="frontend/assets/js/booking.js"></script>
